...
<div class="row">
    ...
    <div class="col-lg-8 p-4">
        ...
        <ul class="nav nav-tabs" role="tablist">
            ...
            ?>
                <li class="nav-item">
                    <button class="nav-link <?php $key === 0 ? 'active' : '' ?>" data-bs-toggle="tab" data-bs-target="#tab-pane-<?php echo $key ?>">
        ...
        <div class="tab-content mt-3">
            ...
            ?>
                <!-- ================= TAB COFFEE ================= -->
                <div class="tab-pane fade <?php $key === 0 ? 'show active' : '' ?>" id="tab-pane-<?php echo $key ?>">
                    ...
                    <div class="row g-3">
                        ...
                        ?>
                                <div class="col-md-4">
                                    <div class="card product-card" onclick='addToChart({
                                    id: <?= $rowP["id"] ?>,
                                    ...
                                    image: "assets/img/<?= $rowP["product_photo"] ?>"
                                        ...
                                        <div class="px-3">
                                            ...
                                            <p class="text-muted">Ready Stock <?php echo $rowP['qty'] ?> pcs</p>
                                        </div>
                                    </div>
                                </div>
    ...
    <div class="col-lg-4 p-4">
        ...
        <ul class="nav nav-tabs">
            <li class="nav-item">
                <button class="nav-link active">Detail Pesanan</button>
            </li>
            <li class="nav-item">
                <button class="nav-link">Simpan Pesanan</button>
            </li>
        </ul>

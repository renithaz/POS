...
<body>
    ...
    <!-- Chart JS -->
    <script src="assets/template/assets/js/plugin/chart.js/chart.min.js"></script>

    <!-- jQuery Sparkline -->
    <script src="assets/template/assets/js/plugin/jquery.sparkline/jquery.sparkline.min.js"></script>

    <!-- Chart Circle -->
    <script src="assets/template/assets/js/plugin/chart-circle/circles.min.js"></script>

    <!-- Datatables -->
    <script src="assets/template/assets/js/plugin/datatables/datatables.min.js"></script>

    <!-- Bootstrap Notify -->
    <script src="assets/template/assets/js/plugin/bootstrap-notify/bootstrap-notify.min.js"></script>

    <!-- jQuery Vector Maps -->
    <script src="assets/template/assets/js/plugin/jsvectormap/jsvectormap.min.js"></script>
    <script src="assets/template/assets/js/plugin/jsvectormap/world.js"></script>
    ...
    <script src="assets/template/assets/js/setting-demo.js"></script>
